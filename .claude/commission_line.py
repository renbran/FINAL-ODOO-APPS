...
class CommissionLine(models.Model):
    ...
    sale_order_line_id = fields.Many2one(
        ...
        ondelete='cascade',
        help='Related sale order line item'
    )
    ...
    purchase_line_id = fields.Many2one(
        ...
        ondelete='set null',
        help='Related purchase order line item'
    )
    po_ref = fields.Char(
        string='PO Reference', 
    ...
    vendor_bill_id = fields.Many2one(
        ...
        ondelete='set null',
        help='Related vendor bill for commission payment'
    )
    ...
    product_id = fields.Many2one(
        ...
        string='Product',
        ondelete='set null',
        help='Related product for commission calculation'
    )
    ...
    role = fields.Selection([
        ...
        ('second_agent', 'Second Agent'),
    ], string='Commission Role', tracking=True,
       help='The role of the partner in this commission')
    ...
    calculation_method = fields.Selection([
        ...
        ('fixed', 'Fixed Amount'),
        ('tiered', 'Tiered'),
    ], string='Calculation Method', default='percentage',
       help='Method used to calculate commission amount')
    
    calculation_base = fields.Selection([
        ('unit_price', 'Unit Price'),
        ('order_total_untaxed', 'Order Total (Untaxed)'),
    ], string='Calculation Base',
       help='Which field to use as base for commission calculation'
    )
