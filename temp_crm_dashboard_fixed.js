...
function formatCurrency(value) {
    ...
    if (absValue >= 1000000000) {
        ...
        // Thousands
        formatted = (value / 1000000).toFixed(2) + ' K';
    } else {
        // Less than 1000
    ...
    onclick_this_week(ev) {
        ...
        jsonrpc('/web/dataset/call_kw/crm.lead/crm_week', {
            ...
            .then(function(result) {
                ...
                $('#exp_rev_this_week').append('<span>' + self.monthly_goals[2] + '&nbsp' + formatCurrency(result.record_rev_exp) + '</span>');
                $('#rev_this_week').append('<span>' + self.monthly_goals[2] + '&nbsp' + formatCurrency(result.record_rev) + '</span>');
    ...
    onclick_this_month(ev) {
        ...
        jsonrpc('/web/dataset/call_kw/crm.lead/crm_month', {
            ...
            .then(function(result) {
                ...
                $('#exp_rev_this_month').append('<span>' + self.monthly_goals[2] + '&nbsp' + formatCurrency(result.record_rev_exp) + '</span>');
                $('#rev_this_month').append('<span>' + self.monthly_goals[2] + '&nbsp' + formatCurrency(result.record_rev) + '</span>');
    ...
    onclick_this_quarter(ev) {
        ...
        jsonrpc('/web/dataset/call_kw/crm.lead/crm_quarter', {
            ...
            .then(function(result) {
                ...
                $('#exp_rev_this_quarter').append('<span>' + self.monthly_goals[2] + '&nbsp' + formatCurrency(result.record_rev_exp) + '</span>');
                $('#rev_this_quarter').append('<span>' + self.monthly_goals[2] + '&nbsp' + formatCurrency(result.record_rev) + '</span>');
    ...
    onclick_this_year(ev) {
        ...
        jsonrpc('/web/dataset/call_kw/crm.lead/crm_year', {
            ...
            .then(function(result) {
                ...
                $('#exp_rev_this_year').append('<span>' + self.monthly_goals[2] + '&nbsp' + formatCurrency(result.record_rev_exp) + '</span>');
                $('#rev_this_year').append('<span>' + self.monthly_goals[2] + '&nbsp' + formatCurrency(result.record_rev) + '</span>');
