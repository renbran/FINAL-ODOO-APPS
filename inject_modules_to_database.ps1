# ============================================
# MODULE INJECTION SCRIPT FOR NEW/RESTORED DATABASES
# ============================================
...
Write-Host "🚀 Module Injection to Database: $DatabaseName" -ForegroundColor Green
...
# Function to inject modules via Docker
...
if ($ModuleList -ne "") {
    ...
    Write-Host "📋 Available injection options:" -ForegroundColor Yellow
