...
echo "- Health Check: http://testerp.com/api/v1/status"
echo "- Generate API Key: http://testerp.com/api/v1/auth/generate-key"
echo "- CRM APIs: http://testerp.com/api/v1/crm/*"
echo "- Sales APIs: http://testerp.com/api/v1/sales/*"
echo "- Payment APIs: http://testerp.com/api/v1/payments/*"
echo ""
