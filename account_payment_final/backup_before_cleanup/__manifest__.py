# -*- coding: utf-8 -*-
{
    ...
    'assets': {
        'web.assets_backend': [
            # MODERN ODOO 17 COMPATIBILITY: Must load FIRST to handle legacy odoo.define() calls
            ('prepend', 'account_payment_final/static/src/js/modern_odoo17_compatibility.js'),
            ...
            # Core JavaScript functionality - Now enabled with modern syntax
        ...
        'web.assets_web_dark': [
            ...
            # Core JavaScript functionality for dark theme
            'account_payment_final/static/src/js/payment_workflow_realtime.js',
            'account_payment_final/static/src/js/views/payment_list_view.js',
